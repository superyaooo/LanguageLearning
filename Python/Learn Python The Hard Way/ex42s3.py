...
class Engine(object):
    ...
    def play(self): 
        ...
        while True:
            print "-------------"
            room = getattr(a_map, next)  # gets function princess_lives_here()
            next = room()         # runs function princess_lives_here(), returns 'death' to next


a_game = Engine('princess_lives_here') 
