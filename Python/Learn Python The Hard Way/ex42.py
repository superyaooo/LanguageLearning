...
class Game(object):
    ...
    def __init__(self, start):
        ...
        self.start = start   # sets interval variables 'quips' and 'start'
    ...
    def play(self):
        ...
        while True:
            print "\n-----------"
            room = getattr(self, next)  # gets attribute
            next = room()
...
a_game = Game("princess_lives_here")  # starts with princess room
a_game.play() # calls function play()
